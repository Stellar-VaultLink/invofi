...
| `src/i18n/messages.test.ts` | Every locale has a file; no unknown keys; placeholders preserved; ICU parses per locale; English fallback for untranslated keys; Arabic is complete. |
