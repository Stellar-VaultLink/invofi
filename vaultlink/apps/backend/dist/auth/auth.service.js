...
let AuthService = class AuthService {
    ...
    async register(email, password, stellarAccountId) {
    ...
    async verifyStellarSignature(publicKey, signature, message) {
        try {
            const kp = stellar_sdk_1.Keypair.fromPublicKey(publicKey);
